...
const Lang_Selection = dynamic(() => import("../components/ui/Lang_Selection"));
  ...
  return (
    <main className="flex flex-col relative">
      ...
      <div className="absolute w-screen h-[80vh] sm:h-[95vh]">
        ...
        />
        <div 
          className="z-50 flex absolute items-center space-x-2 top-10 h-6 my-5 mx-[15vw] sm:top-0 sm:right-0 md:h-8 md:me-44"
        >
          <Lang_Selection />
          <SignIn_Button />
        </div>
