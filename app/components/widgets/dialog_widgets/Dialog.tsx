...
const Dialog =(
  ...
  const { continueWatchingVideoElement } = useVideoContext();
  ...
  const handleVideoClick = () => {
    ...
    allVideos.forEach((video: HTMLVideoElement) => {
      if (video !== continueWatchingVideoElement.current ) {
        video.pause();
      ...
      <div className="flex flex-col relative w-full h-full">
        ...
        <div className='w-auto h-auto'>
          <VideoModals
            ...
            videoStyle="continueVideo -z-20 absolute w-full h-[55vw] sm:h-[45vw] md:h-[30vw] object-fill brightness-75"
            enableLoop={false}
